                    ...
                    <section class="content ">
                        <div class="card mb-4">
                            <div class="card-header">
                                <h4 class="mb-0">{{ __('store-admin.your_profile_details') }}</h4>
                            </div>
                            <div class="card-body">
                                ...
                                @csrf
                                    ...
                                    @endphp
                                    <input type="hidden" name="user_id" class="user-id" value="{{!empty($cashier_admin_details) && !empty($cashier_admin_details[0]->id) ? Crypt::encrypt($cashier_admin_details[0]->id) : '' }}">
                                    <input type="hidden" class="email-path" value="{{ route('email-exist') }}">
                                    <input type="hidden" class="is_admin" value="3">
                                    <input type="hidden" name="store_id" class="store-id" value="{{!empty($cashier_admin_details) && !empty($cashier_admin_details[0]->store_id) ? Crypt::encrypt($cashier_admin_details[0]->store_id) : '' }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-4 input-field-div">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" data-label = "{{ __('store-admin.email_address') }}" data-type="cashier-admin" name="email" value = "{{!empty($cashier_admin_details) && !empty($cashier_admin_details[0]->email) ? $cashier_admin_details[0]->email : '' }}" class="form-control required-field form-input-field email-field" disabled>
                                                </div>
                                                @if ($errors->has('email'))
                                            ...
                                            <div class="mb-4 input-field-div">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" data-label = "{{ __('store-admin.phone_number') }}" data-min="10" data-max="12" name="phone_number" value = "{{!empty($cashier_admin_details) && !empty($cashier_admin_details[0]->phone_number) ? $cashier_admin_details[0]->phone_number : '' }}" data-pattern="^[0-9]+$" data-error-msg="{{ __('validation.invalid_numeric_err') }}" onkeypress="return restrictCharacters(event)" class="form-control required-field form-input-field">
                                                </div>
                                        ...
                                        @if(!empty(Auth::user()->is_admin) && Auth::user()->is_admin == 2) 
                                            <div class="col-md-6">
                                                        ...
                                                        <select class="form-control required-field form-input-field country-list dropdown-search" data-label = "{{ trans('admin.country') }}" name="store_country">
                                                            ...
                                                            @if(isset($countries) && !empty($countries))
                                                                @foreach ($countries as $country)
                                                                    <option value="{{ $country->id }}" {{!empty($cashier_admin_details) && !empty($cashier_admin_details[0]->country_id) && ($cashier_admin_details[0]->country_id == $country->id) ? "selected" : '' }}>{{ $country->name }}</option> 
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                ...
                                                <input type="hidden" class="state-id" value="{{!empty($cashier_admin_details) && !empty($cashier_admin_details[0]->state_id) ? $cashier_admin_details[0]->state_id : ''}}">
                                                <input type="hidden" class="city-id" value="{{!empty($cashier_admin_details) && !empty($cashier_admin_details[0]->city_id) ? $cashier_admin_details[0]->city_id : ''}}">
                                                <div class="mb-4 input-field-div">
