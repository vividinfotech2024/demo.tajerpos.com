                ...
                <div class="container">
                    ...
                    <div class="invoice-owner-conte-wrap">
                        <div class="invo-to-wrap">
                            <div class="invoice-to-content">
                                ...
                                <h1 class="invo-to-owner inter-700 md-lg-font">{{!empty($store_admin_details) && !empty($store_admin_details[0]->store_name ) ? $store_admin_details[0]->store_name  : '' }}</h1>
                                <p class="invo-owner-address medium-font inter-400 mtb-0">Phone: {{!empty($store_admin_details) && !empty($store_admin_details[0]->store_phone_number ) ? $store_admin_details[0]->store_phone_number  : '' }} <br> Email: {{!empty($store_admin_details) && !empty($store_admin_details[0]->email ) ? $store_admin_details[0]->email  : '' }}</p>
                            </div>
                        </div>
                    ...
                    <!-- <div class="rest-payment-bill">
                        ...
                        <div class="signature-wrap">
                            <div class="sign-img">
                                <img src="{{ URL::asset('assets/imgs/sign.svg') }}" alt="this is signature image">
                            </div>
                    ...
                    <div class="invo-print-btn invo-btns">
                        <a href="javascript:window.print()" class="print-btn">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_5_313)">
                                <path d="M14 3V7C14 7.26522 14.1054 7.51957 14.2929 7.70711C14.4804 7.89464 14.7348 8 15 8H19" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M17 21H7C6.46957 21 5.96086 20.7893 5.58579 20.4142C5.21071 20.0391 5 19.5304 5 19V5C5 4.46957 5.21071 3.96086 5.58579 3.58579C5.96086 3.21071 6.46957 3 7 3H14L19 8V19C19 19.5304 18.7893 20.0391 18.4142 20.4142C18.0391 20.7893 17.5304 21 17 21Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M9 7H10" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M9 13H15" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M13 17H15" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></g><defs><clipPath id="clip0_5_313"><rect width="24" height="24" fill="white"></rect>
                                </clipPath></defs></svg>
                            <span class="inter-700 medium-font">Print</span>
                        </a>
                    </div>
                    <div class="invo-down-btn invo-btns">
                        <a href="{{ config('app.prefix_url').'/admin/store/invoice/'.Crypt::encrypt($store_id).'/download' }}" class="download-btn" id="generatePDF">
