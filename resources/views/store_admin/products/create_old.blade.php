            ...
            <div class="content-wrapper" >
                <div class="container-full">
                    <section class="content">
                        <form  method="POST" action="{{ route(config('app.prefix_url').'.'.$store_url.'.'.$prefix_url.'.product.store') }}" enctype="multipart/form-data">
                        @csrf
                                        ...
                                        <div class="box-body add-product-info">
                                            <div class="row">
                                                    ...
                                                    <div class="card mb-4">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="mb-4 input-field-div">
                                                                ...
                                                                <textarea id="summernote" class="form-control form-input-field" rows="4" data-label = "{{ __('store-admin.description') }}" data-pattern="^[A-Za-z0-9\u0600-\u06FF\s.,!@#%^&*()_+=\-:;&quot;'/[\]?|{}]+$" data-error-msg="{{ __('validation.description_invalid_msg') }}" onkeypress="return restrictCharacters(event)" name="products[product_description]">{{!empty($product_details) && !empty($product_details[0]->product_description) ? $product_details[0]->product_description : '' }}</textarea>
                                                                <span class="error error-message"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card mb-4 variant-product-fields">
                                                        ...
                                                        <div class="card-body add-variants">
                                                            <div class="col-lg-11 col-md-11 col-sm-10 col-10 input-field-div clone-option-values dnone">                                        
                                                                <input type="text" data-label="{{ __('store-admin.option_values') }}" class="form-control option-values-fields">
                                                                <span class="error error-message"></span>
                                                            </div>
                                                            ...
                                                            <div class="clone-variants-options dnone">
                                                                ...
                                                                <div class="row mb-4">
                                                                    <div class="col-lg-11 col-md-11 col-sm-10 col-10 input-field-div">
                                                                        <input type="text" data-label="{{ __('store-admin.option_name') }}" class="form-control option-name" id="option-name">
                                                                        <span class="error error-message"></span>
                                                                    </div>
                                                                ...
                                                                <div class="option-values-row">
                                                                    <div class="row mb-2 option-values">                                   
                                                                        <div class="col-lg-11 col-md-11 col-sm-10 col-10 input-field-div">   
                                                                        ...
                                                                        <div class="save-option-fields">
                                                                            ...
                                                                            <div class="row mb-4">
                                                                                <div class="col-lg-11 col-md-11 col-sm-10 col-10">
                                                                                    <input type="text" value="{{ $variant->variants_name }}" class="form-control option-name" id="option-name">
                                                                            ...
                                                                            <div class="option-values-row">
                                                                                @if(!empty($variants_options_array) && count($variants_options_array) > 0 && array_key_exists($variant->variants_id,$variants_options_array))
                                                                                    @foreach($variants_options_array[$variant->variants_id] as $k=>$variant_options)
                                                                                        <div class="row mb-2 option-values variants-options-fields-row variants-options-fields-row-{{$k+1}}" data-row="{{$k+1}}">                                   
                                                                                            <div class="col-lg-11 col-md-11 col-sm-10 col-10">                                        
                                                                                                <input type="text" value="{{ $variant_options['variant_options_name'] }}" class="form-control option-values-fields">
                                                                                                <input type="hidden" value="{{ $variant_options['variant_options_id'] }}" class="form-control variant-options-id">
                                                                                            </div>
                                                                                            <div class="col-lg-1 col-md-1 col-sm-2 col-2">
                                                                                                <a href="#" class="btn btn-circle btn-primary btn-xs remove-option-value"><i class="fa fa-trash"></i></a>
                                                                                            </div>
                                                                                        ...
                                                                                        @if(($k+1) == count($variants_options_array[$variant->variants_id]))
                                                                                            <div class="row mb-2 option-values variants-options-fields-row variants-options-fields-row-{{$k+2}}" data-row="{{$k+2}}">                                   
                                                                                                <div class="col-lg-11 col-md-11 col-sm-10 col-10">                                        
                                                                                                    <input type="text" value="" class="form-control option-values-fields">
                                                                                                </div>
                                                                                            </div>
                                                                                        @endif
                                                                                    @endforeach
                                                                                @else
                                                                                    <div class="row mb-2 option-values variants-options-fields-row variants-options-fields-row-1" data-row="1">                                   
                                                                                        <div class="col-lg-11 col-md-11 col-sm-10 col-10">                                        
                                                                                            <input type="text" value="" class="form-control option-values-fields">
                                                                                        </div>
                                                                                    </div>
                                                ...
                                                <div class="col-12 form-actions mt-10" style="text-align: right; width: 100%;">
                                                    <button type="submit" class="btn btn-primary mb-2 save-products-info"> {{ __('store-admin.save') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script>
            $(document).ready(function() {
                $('#summernote').summernote({
                    ...
                    //         $('.note-editable').attr('data-error-msg', langTranslations.description_invalid_msg);
                    //         $('.note-editable').attr('data-pattern', "^[A-Za-z0-9\u0600-\u06FF\s.,!@#%^&*()_+=\-:;&quot;'\/[\]?|{}]+$");
                    //     },
                    //     onKeydown: function (e) {
                    //         return restrictCharacters(e);
                    //     },
                    //     onKeyup: function (e) {
                    //         return restrictCharacters(e);
                    //     }
            ...
            function calculateTax(_this = '') {
                ...
                if(product_type == "single") {
                    ...
                    if (!isNaN(productPrice) && !isNaN(taxPercentage)) {
                        ...
                        _this.closest("tr").find(".unit-price-data").val(0);
                    }
                }
            }
            ...
            //         _this.closest(".input-field-div").find(".error.error-message").text("Invalid extension.").css("color", "#F30000");
            //     else {
            ...
            //                 _this.closest(".input-field-div").find('.remove-image').val(0);
            //             }
            ...
            $(document).on("keyup",".option-values-fields",function(event) {
                ...
                if(!($(this).closest(".variants-options-fields-row").next().hasClass('variants-options-fields-row'))) {
                    ...
                    add_variants_fields = "<div data-row='"+row_count+"' class='row mb-2 variants-options-fields-row variants-options-fields-row-"+row_count+"'></div>";
                    $(add_variants_fields).appendTo($(this).closest(".option-values-row"));
                    $(".variants-options-fields-row-"+row_count).html(variants_option_fields);
            ...
            $(document).on("click",".save-products-info",function() {
                ...
                if(check_fields > 0)
                    ...
                    $(this).closest("form").find(".variants-options-row").find(".option-values-fields").each(function() { 
                        if($(this).val() != "") {
                            variants_options_data = {};
                            variants_options_data.variants_name = $(this).closest(".variants-options-row").find(".option-name").val();
                            variants_options_data.variant_options_id = $(this).closest(".variants-options-fields-row").find(".variant-options-id").val();
                            variants_options_data.variant_options_name = $(this).val();
                            variants_options_array.push(variants_options_data); 
                        }
                    });
                    variants_option_details = JSON.stringify(variants_options_array)
                    $(this).closest("form").find(".save-variants-options-details").val(JSON.stringify(variants_option_details));
