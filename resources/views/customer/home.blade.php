    ...
    <body>
                ...
                @if(isset($bannersDetails) && !empty($bannersDetails))
                    @foreach($bannersDetails as $key => $banner)
                        <div class="carousel-item {{ ($key == 0) ? 'active' : ''}}">
                            <img src="{{ $banner->banner_image }}" alt="Banners" class="d-block w-100">
                        </div>
                    @endforeach
                @endif
            </div>
        ...
        <div class="product_section mb-80 wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1.1s">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <a href="{{ route($store_url.'.customer.category',Crypt::encrypt('home_page')) }}"><button type="button" style="width:100%;" class="btn btn-link see-all-products">{{ __('customer.see_all_products') }}</button></a>
                    </div>
                </div>  
            </div>
        </div>
