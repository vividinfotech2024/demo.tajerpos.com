...
<body>
    <div class="container">
        ...
        <div class="message">
            ...
            <p>Your account was recently accessed. If this was you, you can ignore this email. If not, please secure your account.</p>
        </div>
        <div class="button">
            <a href="{{ !empty($details) && isset($details['store_url']) ? route($details['store_url'].'.customer.dashboard') : '' }}" target="_blank">Log In to Your Account</a>
        </div>
    </div>
</body>
</html>
