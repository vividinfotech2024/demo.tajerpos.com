...
(function ($) {
    ...
    $.fn.imageUploader = function (options) {
            ...
            plugin.each(function (i, wrapper) {
                ...
                if (plugin.settings.preloaded.length) {
                    ...
                    for (let i = 0; i < plugin.settings.preloaded.length; i++) {
                        $uploadedContainer.append(createImg(plugin.settings.preloaded[i].src, plugin.settings.preloaded[i].id, true,plugin.settings.preloaded[i].mode));
                    }
        ...
        let createImg = function (src, id, preloaded, mode = '') {
            ...
            let $container = $('<div>', {class: 'uploaded-image'}),
                ...
                $button = $('<button>', {class: 'delete-image delete-product-image','data-mode': mode}).appendTo($container),
            ...
            $button.on("click", function (e) {
                ...
                if ($container.data('preloaded') === true) {
                    ...
                    if(mode == "add")
                        removeProductImg(remove_img_path,$(this));
                } else {
                    // Get the image index
