(function ($) {
    ...
    $('.product_gallery_main_img').on('setPosition', function(event, slick) {
        $('.product_gallery_main_img').find(".slick-slide.slick-active").css({
          'width': '500px',
        });
    });
    ...
    //Quantity Counter
    $('.pro-qty').append('<a href="#" class="plus">+</a>');
    $('.pro-qty').prepend('<a href="#" class= "minus">-</a>');
