    ...
    <div class="col-nav">
        ...
        <ul class="nav">
            ...
            <li class="dropdown nav-item admin-chat-details">
                <input type="hidden" class="chat-list-url" value="<?php echo e(route(config('app.prefix_url').'.admin.chat-list')); ?>">
            ...
            <li class="dropdown nav-item">
                ...
                <a class="dropdown-toggle" data-bs-toggle="dropdown" href="#" id="dropdownAccount" aria-expanded="false"> 
                    <?php if(!empty(Auth::user()->profile_image)): ?>
                        <img class="icon-xs profile-image" src="<?php echo e(Auth::user()->profile_image); ?>" alt="User" />
                    <?php else: ?>
                        <div class="icon-xs default-profile-image"></div>
                    <?php endif; ?>
                </a>
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownAccount">
                    <a class="dropdown-item" href="<?php echo e(route(config('app.prefix_url').'.admin.profile')); ?>"><i class="material-icons md-perm_identity"></i><?php echo e(trans('admin.edit_profile')); ?></a>
                    <a class="dropdown-item" href="<?php echo e(route(config('app.prefix_url').'.admin.change-password')); ?>"><i class="material-icons md-settings"></i><?php echo e(trans('admin.reset_password')); ?></a>                             
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item text-danger" href="<?php echo e(route(config('app.prefix_url').'.admin.logout')); ?>" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="material-icons md-exit_to_app"></i><?php echo e(trans('admin.logout')); ?></a>
                    <form id="logout-form" action="<?php echo e(route(config('app.prefix_url').'.admin.logout')); ?>" method="POST" style="display: none;">
                        <?php echo csrf_field(); ?>
                    </form>
                </div>
            </li>
                            ...
                            <div class="row">
                                <div class="col mr-1">
                                    <div class="position-relative">
                                        <input type="hidden" class="insert-chat-url" value="<?php echo e(route(config('app.prefix_url').'.admin.insert-chat')); ?>">
                                        <input type="hidden" class="get-chat-url" value="<?php echo e(route(config('app.prefix_url').'.admin.get-chat')); ?>">
                                        <input type="hidden" class="admin-unread-chat-url" value="<?php echo e(route(config('app.prefix_url').'.admin.unread-chat-count')); ?>">
                                        ...
                                        <input type="hidden" class="get-logo-image" value="<?php echo e(route('get-logo-image')); ?>" >
...
</aside><?php /**PATH /var/www/html/dev.tajerpos.com/resources/views/common/admin/sidebar.blade.php ENDPATH**/ ?>