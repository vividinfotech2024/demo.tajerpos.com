...
<html lang="en">
  <head>
    <?php $role_name = Auth::user()->is_admin == 2 ? __('store-admin.store_admin') : __('store-admin.cashier');  ?>
    <title><?php echo e(__('store-admin.dashboard_page_title',['company' => Auth::user()->company_name, 'role_name' => $role_name])); ?></title>
          ...
          <div class=" ">
                    ...
                    <div class="box">
                      <div class="box-body">
                          <div class="d-flex align-items-start">
                            <div>
                                <img src="<?php echo e(asset('images/dashboard/Icons-07.png')); ?>" class="mr-20 pos-d" alt="" />
                            </div>
                            <a href="<?php echo e(route(config('app.prefix_url').'.'.$store_url.'.'.config('app.module_prefix_url').'.product.index')); ?>">
                                <div>
                                  <h2 class="sar_header my-0"><?php echo e($total_product_count); ?></h2>
                ...
                <div class="col-lg-4 col-12">
                    <div class="box">
                      <div class="box-body">
                          <div class="d-flex align-items-start">
                            <div>
                                <img src="<?php echo e(asset('images/dashboard/Icon-08.png')); ?>" class="mr-20 pos-d1" alt="" />
                            </div>
                            <a href="<?php echo e(route(config('app.prefix_url').'.'.$store_url.'.'.config('app.module_prefix_url').'.place-order.index')); ?>">
                                <div>
                                  <h2 class="my-0 sar_header"><?php echo e($total_instoreorder_count); ?></h2>
                ...
                <div class="col-lg-4 col-12">
                    <div class="box">
                      <div class="box-body">
                          <div class="d-flex align-items-start">
                            <div>
                                <img src="<?php echo e(asset('images/dashboard/Icons-09.png')); ?>" class="mr-20 pos-d" alt="" />
                            </div>
                            <div>
              ...
              <div class="row">
                <div class="col-lg-8 col-12">
                    <div class="mb-3">
                      <a href="<?php echo e(route(config('app.prefix_url').'.'.$store_url.'.'.config('app.module_prefix_url').'.store-order.index')); ?>">
                          <div class="box-body my_cust" style="position: relative;width: 100%">
                            <div class="cust_fnt">Today's Orders</div>
                            <p class="my_day"><?php echo e(date(' l j, F   Y ')); ?></p>
                            <div class="my_amt">
                                ﷼<?php echo e(number_format($total_revenue_today,2)); ?>
                            ...
                            <div class="row d-flex justify-content-between">
                                <div class="col-md-3">
                                  ...
                                  <p class="my_day2"><?php echo e($total_instoreorder_today_count); ?></p>
                                </div>
                                <div class="col-md-3">
                                  <div class="my_day2">
                                      Process
                                  </div>
                                  <p class="my_day2"><?php echo e($total_instoreorder_process_today_count); ?></p>
                                </div>
                                <div class="col-md-3">
                                  <div class="my_day2">
                                      Delivered
                                  </div>
                                  <p class="my_day2"><?php echo e($total_instoreorder_delivered_today_count); ?></p>
                                </div>
                                <div class="col-md-3">
                                  <div class="my_day2">
                                      Cancelled
                                  </div>
                                  <p class="my_day2"><?php echo e($total_instoreorder_cancelled_today_count); ?></p>
                                </div>
                            </div>
                          </div>
                      </a>
                ...
                <div class="col-lg-4 col-12">
                    <div class="mb-3">
                      <a href="<?php echo e(route(config('app.prefix_url').'.'.$store_url.'.'.config('app.module_prefix_url').'.reports.customer-report')); ?>">
                          <div class="box-body my_cust1" style="position: relative;width: 100%">
                            <div class="row">
                                ...
                                <div class="col-md-9 col-6">
                                  ...
                                  <div class="cust2_num"><?php echo e($total_instoreorder_lastmonthcount); ?></div>
                                  <img src="<?php echo e(asset('images/dashboard/Graphs.png')); ?>" class="slide" alt="" />
                                  <div class="custmy_day1">
                                      Right Now
                                  </div>
                                  <div class="cust_count">
                                      <?php echo e($total_instoreorder_count); ?>
                      ...
                      <div class="box-body" style="position: relative;width: 100%">
                          <div class="d-flex justify-content-between">
                            ...
                            <div class="text-right">
                                <h3 class="box-title mb-0 font-weight-700">﷼ <?php echo e(number_format($total_revenue,2)); ?></h3>
                            </div>
                          </div>
                    ...
                    <div class="box mb-3">
                      <div class="box-body" style="position: relative;width: 100%">
                          <div class="d-flex justify-content-between">
                            ...
                            <div class="text-right">
                                <h3 class="box-title mb-0 font-weight-700">﷼ <?php echo e(number_format(1123,2)); ?> </h3>
                            </div>
                          </div>
                                        ...
                                        <div class="box-body1">
                                            <div class="d-flex justify-content-between align-items-center">
                                              <div>
                                                  ...
                                                  <h2 class="mb-0 mx-2 side_sub"> ﷼<?php echo e(number_format($total_revenue,2)); ?></h2>
                                              </div>
                                              <div class="">
                                                  <img src="<?php echo e(asset('images/dashboard/Graphs-07.png')); ?>" class="sidebar_img mr-20 pos-side" alt="" />
                                              </div>
                                            </div>
                                            <div class="box-footer">
                                              <div class="d-flex align-items-center justify-content-between">
                                                  <h5 class="my-0 side_b"><?php echo e($total_instoreorder_count); ?> Orders</h5>
                                      ...
                                      <div class="box no-shadow box-bordered border-light">
                                        <div class="box-body1">
                                            <div class="d-flex justify-content-between align-items-center">
                                              ...
                                              <div class="">
                                                  <img src="<?php echo e(asset('images/dashboard/Graphs-01.png')); ?>" class="sidebar_img mr-20 pos-side" alt="" />
                                              </div>
                                            </div>
                                            <div class="box-footer">
                                              <div class="d-flex align-items-center justify-content-between">
                                      ...
                                      <div class="box no-shadow box-bordered border-light">
                                        <div class="box-body1">
                                            <div class="d-flex justify-content-between align-items-center">
                                              ...
                                              <div class="">
                                                  <img src="<?php echo e(asset('images/dashboard/Graphs-02.png')); ?>" class="sidebar_img mr-20 pos-side" alt="" />
                                              </div>
                                            </div>
                                            <div class="box-footer">
                                              <div class="d-flex align-items-center justify-content-between">
                                      ...
                                      <div class="box no-shadow box-bordered border-light">
                                        <div class="box-body1">
                                            <div class="d-flex justify-content-between align-items-center">
                                              ...
                                              <div class="">
                                                  <img src="<?php echo e(asset('images/dashboard/Graphs-03.png')); ?>" class="sidebar_img mr-20 pos-side" alt="" />
                                              </div>
                                            </div>
                                            <div class="box-footer">
                                              <div class="d-flex align-items-center justify-content-between">
...
</html><?php /**PATH /var/www/html/dev.tajerpos.com/resources/views/cashier_admin/dashboard.blade.php ENDPATH**/ ?>