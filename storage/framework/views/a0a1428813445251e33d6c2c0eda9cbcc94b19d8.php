...
<html class="no-js" lang="zxx">
   ...
   <body>
        ...
        <input type="hidden" class="address-list-url" value="<?php echo e(route($store_url.'.customer.address.index')); ?>">
        <form method="POST" action="<?php echo e(route($store_url.'.customer.placeorder')); ?>" novalidate> 
        <?php echo csrf_field(); ?>
                    ...
                    <div class="row mt-5">
                                ...
                                <div class="col-lg-12">
                                    <div class="card mb-3">
                                        <div class="card-header d-flex align-items-center p-3">
                                            <h6 class="card-title flex-grow-1 mb-0 text-dark fw-bold"><?php echo e(__('customer.shipping_information')); ?></h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="d-flex align-items-center mb-3">
                                                <div class="flex-grow-1">
                                                    <h6 class="fs-md mb-2"><?php echo e(__('customer.choose_address')); ?></h6>
                                                    ...
                                                    <a href="#address" class="card bg-light bg-opacity-25 border border-light-subtle shadow-none h-100 text-center">
                                                        <div class="card-body d-flex justify-content-center align-items-center">
                                                            <div>
                                                                ...
                                                                <div class="fw-medium mt-n1 text-primary-emphasis stretched-link address-details-info" data-type="add" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"><?php echo e(__('customer.add_address')); ?></div>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </div>
                        ...
                        <div class="col-lg-4">
                                ...
                                <div class="col-lg-12">
                                    <div class="card mb-3">
                                        <div class="card-header p-3">
                                            <div class="d-flex">
                                                <div class="flex-grow-1">
                                                    <h6 class="card-title mb-0 text-dark fw-bold"><?php echo e(__('customer.order_summary')); ?></h6>
                                                </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-borderless align-middle mb-0 product-checkout-table">
                                                    <thead class="table-active text-muted">
                                                        <tr>
                                                            <th style="width: 90px;" scope="col"><?php echo e(__('customer.image')); ?></th>
                                                            <th scope="col"><?php echo e(__('customer.product_info')); ?></th>
                                                            <th scope="col" class="text-end"><?php echo e(__('customer.price')); ?></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody class="card-details-tbody">
                                                        <?php if(isset($product_details) && !empty($product_details)): ?>
                                                            <?php $__currentLoopData = $product_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php if(($product->type_of_product == 'variant' && $product->product_available != 'out-of-stock') || ($product->type_of_product == 'single' && ($product->trackable == 0 || ($product->trackable == 1 && $product->unit > 0)))): ?>
                                                                    <tr class="cart-item">
                                                                        <?php if($product->type_of_product == 'variant'): ?>
                                                                            <?php $product_quantity =  ($product->on_hand != "" && $product->on_hand < $get_quantity[$product->product_id][$product->variants_combination_id]) ? $product->on_hand : $get_quantity[$product->product_id][$product->variants_combination_id]; ?> 
                                                                        <?php else: ?>
                                                                            <?php $product_quantity =  ($product->trackable == 1 && $product->unit < $get_quantity[$product->product_id]) ? $product->unit : $get_quantity[$product->product_id]; ?> 
                                                                        <?php endif; ?>
                                                                        <input type="hidden" class="product-quantity quantity" value="<?php echo e($product_quantity); ?>">
                                                                        <input type="hidden" class="select-variants" value="<?php echo e($product->variants_combination_id); ?>">
                                                                        <input type="hidden" class="product-price" value="<?php echo e(($product->type_of_product == 'variant') ? $product->variant_price : $product->price); ?>">
                                                                        ...
                                                                        <input type="hidden" class="total-product-item-val" value="<?php echo e($product_quantity * (($product->type_of_product == 'variant') ? $product->variant_price : $product->price)); ?>">
                                                                        <input type="hidden" class="variant-combination-name" value="<?php echo e(($product->type_of_product == 'variant') ? $product->variants_combination_name : ''); ?>" />
                                                                        <td>
                                                                            <?php 
                                                                                $category_image = !empty($product->category_image) ? explode("***",$product->category_image) : [];
                                                                            ?>
                                                                            <?php if(count($category_image) > 0): ?>
                                                                                <div class="avatar-md me-2"><div class="avatar-title rounded-1 "><img style="width: 70px;" src="<?php echo e($category_image[0]); ?>" alt="Product Img"></div></div>
                                                                            <?php endif; ?>
                                                                        </td>
                                                                        <td>
                                                                            <div class="cart-descrp">
                                                                                <div class="product-name">
                                                                                    <a class="fw-bold cart-product-name" href="#"><?php echo e($product->product_name); ?><?php echo e(($product->type_of_product == "variant") ? " - ".$product->variants_combination_name : ""); ?></a>  
                                                                                    <p class="text-muted fw-medium mb-0"><?php echo e(($product->type_of_product == 'variant') ? $product->variant_price : $product->price); ?> x <?php echo e($product_quantity); ?></p>
                                                                                    <?php if(($product->type_of_product == 'variant' && $product->on_hand != "" && $product->on_hand < $get_quantity[$product->product_id][$product->variants_combination_id]) || ($product->type_of_product == 'single' && $product->trackable == 1 && $product->unit < $get_quantity[$product->product_id])): ?>
                                                                                        <?php $available_quantity = ($product->type_of_product == 'variant') ? $product->on_hand : $product->unit; ?>
                                                                                        <div class="mb-15 unavailable-error-message">
                                                                                            <span class="text-danger">Quantity adjusted to <?php echo e($available_quantity); ?> due to limited stock availability.</span>
                                                                                        </div>
                                                                                    <?php endif; ?>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td class="text-end fw-semibold"><?php echo e($product_quantity * (($product->type_of_product == 'variant') ? $product->variant_price : $product->price)); ?></td>
                                                                    </tr> 
                                                                <?php endif; ?>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                                        <?php else: ?>
                                                            <tr><td colspan="3" class="text-center"><?php echo e(__('customer.cart_empty_message')); ?></td></tr>
                                                        <?php endif; ?>
                                                    </tbody>
                                                    <tfoot>
                                                        <?php if(isset($product_details) && !empty($product_details)): ?>
                                                            <tr class="input-field-div text-center">
                                                                <td colspan="3">
                                                                    <div class="coupon-all w-100 ">
                                                                        <div class="coupon w-100 d-flex mb-4">
                                                                            <input id="coupon-code-input" class="input-text w-75 coupon-code hide-show-field" name="coupon_code" value="" placeholder="<?php echo e(__('customer.coupon_code')); ?>" type="text">
                                                                            <input class="button mt-xxs-30 w-25 apply-coupon-button" name="apply_coupon" value="<?php echo e(__('customer.apply')); ?>"type="button">
                                                                ...
                                                                <!-- <td class="text-left align-middle">
                                                                    <button type="button" class="btn btn-default apply-coupon-button"><?php echo e(__('customer.apply')); ?></button>
                                                                </td> -->
                                                            </tr>
                                                            <tr class="cart-subtotal">
                                                                <td class="fw-semibold"><?php echo e(__('customer.sub_total')); ?> :</td>
                                                                <td class="fw-semibold text-end amount cart-sub-total" colspan="2"></td>
                                                            </tr>
                                                            <tr>
                                                                <td><?php echo e(__('customer.discount')); ?> : </td>
                                                                <td class="text-end amount coupon-total-discount" colspan="2">SAR 0.00</td>
                                                            </tr>
                                                            <tr>
                                                                <td><?php echo e(__('customer.tax')); ?> (<?php echo e(isset($tax_details) && count($tax_details) > 0 ? preg_replace('/\.?0+%?$/', '%', $tax_details[0]['tax_percentage']) : ""); ?>): </td>
                                                                <td class="text-end amount cart-tax-total" colspan="2">SAR 0.00</td>
                                                            </tr>
                                                            <tr class="order-total border-top border-dashed">
                                                                <td class="fw-semibold"><?php echo e(__('customer.grand_total')); ?>:</td>
                            ...
                            <div class="order-button-payment">
                                <input value="<?php echo e(__('customer.place_order')); ?>" class="mt-0 place-the-order hide-show-field"  type="submit">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <?php echo $__env->make('common.customer.address_popup', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <script src="<?php echo e(URL::asset('assets/customer/js/address.js')); ?>"></script>
        <script>
            ...
            $(document).on("click",".apply-coupon-button",function() {
                ...
                if(coupon_code != "") {
                    $.ajax({
                        ...
                        url: "<?php echo e(route($store_url.'.customer.get-coupon-code-details')); ?>",
                        type: "POST",
                        dataType: 'json',
...
</html><?php /**PATH /var/www/html/dev.tajerpos.com/resources/views/customer/checkout.blade.php ENDPATH**/ ?>